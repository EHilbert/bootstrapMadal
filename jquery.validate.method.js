...
//两位非负小数
jQuery.validator.addMethod("decimals2", function(value, element) {
	var reg = /^(([1-9]+)|([0-9]+\.[0-9]{1,2}))$/;
    return this.optional(element) || reg.test(value);         
}, "数字格式  非负数 小数点后保留两位");
//四位非负小数
jQuery.validator.addMethod("decimals4", function(value, element) {
...
$.validator.setDefaults({
	...
	showErrors : function(errorMap, errorList) {  
	    ...
	    if (msg != "")
	    	//top.$("body").modalDialog().alert(msg);
	    	alert(msg);
	    	return;
	   	},  
	   // 失去焦点时不验证   
